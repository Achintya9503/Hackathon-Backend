...
public class Util {
	...
	public String getUId(String idToken) throws InterruptedException {
		...
		try {
			...
			System.out.println("Change reflected: ");
		...
		// Task<FirebaseToken> task =
		// FirebaseAuth.getInstance().verifyIdToken(idToken).addOnSuccessListener(new
		// OnSuccessListener<FirebaseToken>() {
